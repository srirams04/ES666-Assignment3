...
def stitch_images_cylindrical(img1, img2, focal_length):
...
focal_length = (14.0 * 100000) / 5.74  # Adjust based on your camera setup

# Perform cylindrical stitching
stitched_result = stitch_images_cylindrical(img1, img2, focal_length)

# Show and save the result
cv2.imshow("Stitched Image (Cylindrical)", stitched_result)
cv2.imwrite("stitched_output_cylindrical.jpg", stitched_result)
cv2.waitKey(0)
